...
import { Home, Brain, ShoppingCart, Sparkles, Wallet, Users, UserCircle2 } from "lucide-react";
    ...
    <div className="fixed bottom-0 left-0 right-0 z-50">
      ...
      <div className="bg-white/80 backdrop-blur-2xl border-t border-emerald-100/80 shadow-[0_-4px_24px_rgba(0,0,0,0.07)]">
        <div className="container mx-auto max-w-md">
          <nav className="flex items-center justify-around h-[62px] px-2">
            {links.map(({ href, icon: Icon, label }) => {
              ...
              return (
                ...
                >
                  ...
                  <div className={cn(
                    "flex flex-col items-center gap-[3px] px-3 py-1.5 rounded-2xl transition-all duration-300",
                    isActive
                    ...
                    <Icon
                      className={cn(
                        ...
                        isActive
                          ? "w-[19px] h-[19px] text-white"
                          : "w-[18px] h-[18px] text-slate-400 group-hover:text-emerald-600"
                      )}
                      strokeWidth={isActive ? 2.5 : 1.8}
                    />
                    <span className={cn(
                      "text-[10px] leading-none font-semibold transition-all duration-300 whitespace-nowrap",
