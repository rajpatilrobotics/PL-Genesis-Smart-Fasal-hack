          ...
          <Card className="w-full">
            <CardContent className="p-5 space-y-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-semibold text-sm">{t("onboarding.step1Title")}</span>
              </div>
              <div className="space-y-1">
                <Label htmlFor="fullName">{t("onboarding.fullName")} *</Label>
                <Input id="fullName" placeholder={t("onboarding.fullNamePlaceholder")} value={form.fullName} onChange={e => set("fullName", e.target.value)} />
              </div>
              <div className="space-y-1">
                <Label htmlFor="phone">{t("onboarding.phone")}</Label>
                <Input id="phone" placeholder={t("onboarding.phonePlaceholder")} value={form.phone} onChange={e => set("phone", e.target.value)} type="tel" />
              </div>
          ...
          <Card className="w-full">
            <CardContent className="p-5 space-y-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-semibold text-sm">{t("onboarding.step2Title")}</span>
              </div>
              <div className="space-y-1">
                <Label htmlFor="village">{t("onboarding.village")}</Label>
                <Input id="village" placeholder={t("onboarding.villagePlaceholder")} value={form.village} onChange={e => set("village", e.target.value)} />
              </div>
              <div className="space-y-1">
                <Label htmlFor="district">{t("onboarding.district")}</Label>
                <Input id="district" placeholder={t("onboarding.districtPlaceholder")} value={form.district} onChange={e => set("district", e.target.value)} />
              </div>
              <div className="space-y-1">
          ...
          <Card className="w-full">
            <CardContent className="p-5 space-y-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-semibold text-sm">{t("onboarding.step3Title")}</span>
              </div>
              <div className="space-y-1">
                <Label htmlFor="farmSize">{t("onboarding.farmSize")}</Label>
                <Input id="farmSize" placeholder={t("onboarding.farmSizePlaceholder")} value={form.farmSizeAcres} onChange={e => set("farmSizeAcres", e.target.value)} type="number" min="0" />
              </div>
              <div className="space-y-1">
              ...
              <div className="space-y-1">
                ...
                <Input id="experience" placeholder={t("onboarding.experiencePlaceholder")} value={form.farmingExperienceYears} onChange={e => set("farmingExperienceYears", e.target.value)} type="number" min="0" />
              </div>
              <div className="flex gap-3">
                ...
                <Button className="flex-1" onClick={handleFinish} disabled={isPending}>
                  {isPending ? t("onboarding.saving") : t("onboarding.finishSetup")}
                </Button>
              </div>
            </CardContent>
          </Card>
