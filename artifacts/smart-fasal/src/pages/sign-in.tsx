...
import { Leaf, Mail, Lock, ArrowRight, Loader2, Eye, EyeOff, UserX } from "lucide-react";
      ...
      <div className="relative z-10 w-full max-w-sm">
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl shadow-black/20 p-8 border border-white/40">
          ...
          <p className="text-center text-sm text-gray-500 mt-4">
            ...
            <button onClick={() => setLocation("/sign-up")} className="text-emerald-600 font-semibold hover:text-emerald-700">
              Create one
            </button>
          </p>
        </div>
